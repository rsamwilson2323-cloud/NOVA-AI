 ...
 * entirely in the NOVA browser tab.
 *
...
export class NovaWakeWordDetector {
  private recognition: SpeechRecognitionLike | null = null;
  private ctor: SpeechRecognitionCtor | null;
  private phrase = "hey nova";
  ...
  start(opts: WakeWordOptions): boolean {
    ...
    this.phrase = (opts.phrase || "hey nova").toLowerCase().trim();
  ...
  setPhrase(phrase: string): void {
    this.phrase = (phrase || "hey nova").toLowerCase().trim();
  }
